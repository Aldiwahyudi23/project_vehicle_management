...
class ViosSeeder extends Seeder
{
    public function run(): void
    {
        $dataPath = database_path('seeders/Vehicles/Toyota/data/vios.json');

        if (!File::exists($dataPath)) {
            $this->command->error("File data Vios tidak ditemukan: {$dataPath}");
            return;
        }
